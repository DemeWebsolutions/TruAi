...
class Auth {
    ...
    /**
     * Whether the user must change password (e.g. after reset or first login)
     */
    public function getRequiresPasswordChange() {
        return !empty($_SESSION['requires_password_change']);
    }
    ...
    public function changePassword($currentPassword, $newPassword) {
        ...
        $this->db->execute(
            "UPDATE users SET password_hash = :hash, requires_password_change = 0 WHERE id = :id",
