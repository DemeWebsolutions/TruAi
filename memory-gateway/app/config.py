...
# Default collections (created on startup if missing)
DEFAULT_COLLECTIONS = ["truai_episodes", "phantom_episodes", "gemini_episodes", "shared_knowledge"]
PAYLOAD_INDEX_KEYS = ["project_id", "intent", "risk_level", "visibility", "source_system"]
